  ...
  return (
    <>
      <button 
        ...
        className="fixed bottom-24 right-4 bg-primary text-white p-4 rounded-full shadow-lg shadow-primary/40 hover:scale-105 transition-transform z-40"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="fixed bottom-24 right-4 w-80 h-[28rem] bg-white rounded-2xl shadow-2xl border border-slate-100 flex flex-col z-50 overflow-hidden"
          >
            {/* Header */}
